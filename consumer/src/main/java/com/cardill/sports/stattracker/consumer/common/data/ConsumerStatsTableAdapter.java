...
public class ConsumerStatsTableAdapter extends AbstractTableAdapter<HistoricalStatType, ConsumerGamePlayer, Stat> {
    ...
    public ConsumerStatsTableAdapter(Context context, int viewType) {
        super(context);
    ...
    public void onBindColumnHeaderViewHolder(AbstractViewHolder holder, Object columnHeaderItemModel, int
            position) {
        HistoricalStatType columnHeader = (HistoricalStatType) columnHeaderItemModel;
    ...
    public class MyRowHeaderViewHolder extends AbstractViewHolder {
        ...
        public final TextView cell_textview;
        private ConsumerGamePlayer player;
        ...
        public void setPlayer(ConsumerGamePlayer player) {
            this.player = player;
        }

        public ConsumerGamePlayer getPlayer() {
            return player;
        }
    }
    ...
    public void onBindRowHeaderViewHolder(AbstractViewHolder holder, Object rowHeaderItemModel, int
            position) {
        ConsumerGamePlayer rowHeader = (ConsumerGamePlayer) rowHeaderItemModel;
