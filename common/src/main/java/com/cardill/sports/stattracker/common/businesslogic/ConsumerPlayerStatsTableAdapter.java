...
public class ConsumerPlayerStatsTableAdapter extends AbstractTableAdapter<PlayerStatType, ConsumerGamePlayer, Stat> {
    ...
    public ConsumerPlayerStatsTableAdapter(Context context, int viewType) {
        super(context);
