...
import com.cardill.sports.stattracker.creator.teamcreation.businesslogic.PlayerComparator;
...
class PlayerListPresenter{
    ...
    public PlayerListPresenter(PlayersViewModel viewModel, CreatorCardillService cardillService, LeagueRepository leagueRepository) {
